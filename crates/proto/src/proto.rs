...
messages!(
    ...
    (GetProjectLineCounts, Background),
    (CancelProjectLineCounts, Background),
    (GetProjectLineCountsResponse, Background),
...
request_messages!(
    ...
    (GetProjectLineCounts, GetProjectLineCountsResponse),
...
entity_messages!(
    ...
    GetHover,
    GetProjectSymbols,
    GetProjectLineCounts,
    CancelProjectLineCounts,
    GetReferences,
    GetSignatureHelp,
    OpenUnstagedDiff,
    OpenUncommittedDiff,
